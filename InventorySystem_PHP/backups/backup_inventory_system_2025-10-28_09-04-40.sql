-- Database Backup
-- Generated on: 2025-10-28 09:04:40
...
INSERT INTO `product` VALUES ('p001','p001','Amoxicillin 500mg','Amoxicillin 500mg','115','115','45.00','45.00','65.00','65.00','Antibiotic','Antibiotic','s01','s01','2026-08-15','2026-08-15','2025-10-25 16:48:00','2025-10-25 16:48:00');
...
INSERT INTO `product` VALUES ('p004','p004','Ibuprofen 200mg','Ibuprofen 200mg','150','150','35.00','35.00','50.00','50.00','Painkiller','Painkiller','s01','s01','2027-04-12','2027-04-12','2025-10-25 16:48:00','2025-10-25 16:48:00');
INSERT INTO `product` VALUES ('p005','p005','Vitamin C 1000mg','Vitamin C 1000mg','86','86','55.00','55.00','75.00','75.00','Vitamin','Vitamin','s01','s01','2027-01-30','2027-01-30','2025-10-25 16:48:00','2025-10-25 16:48:00');
...
INSERT INTO `product` VALUES ('p017','p017','Zinc Tablet 50mg','Zinc Tablet 50mg','100','100','60.00','60.00','82.00','82.00','Vitamin','Vitamin','s04','s04','2027-10-30','2027-10-30','2025-10-25 16:48:00','2025-10-25 16:48:00');
...
INSERT INTO `product` VALUES ('p030','p030','Vitamin C 1000mg','Vitamin C 1000mg','90','90','54.00','54.00','75.00','75.00','Vitamin','Vitamin','s06','s06','2027-01-30','2027-01-30','2025-10-25 16:48:00','2025-10-25 16:48:00');
...
INSERT INTO `return_details` VALUES ('2','2','p005','p005','s01','s01','Vitamin C 1000mg','Vitamin C 1000mg','55.00','55.00','10','10','2025-11-01 09:30:00','2025-11-01 09:30:00');
...
CREATE TABLE `sales` (
  ...
  PRIMARY KEY (`id`),
  KEY `p_id` (`p_id`),
  CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`p_id`) REFERENCES `product` (`p_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `users` VALUES ('1','1','Kavindu Perera','Kavindu Perera','admin','admin','d033e22ae348aeb5660fc2140aec35850c4da997','d033e22ae348aeb5660fc2140aec35850c4da997','1','1','no_image.png','no_image.png','1','1','2025-10-28 05:28:15','2025-10-28 05:28:15');
